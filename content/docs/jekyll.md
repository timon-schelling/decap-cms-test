...
![Jekyll tutorial blog screenshot](https://monumental-eclair-a72b67.netlify.app/img/screenshot-jekyll-tutorial-blog.png?raw=true)
...
Follow the directions in the Introduction section to [enable Netlify Identity and Git Gateway services](https://monumental-eclair-a72b67.netlify.app/docs/add-to-your-site/#enable-identity-and-git-gateway) for the backend, then [add the Identity widget](https://monumental-eclair-a72b67.netlify.app/docs/add-to-your-site/#add-the-netlify-identity-widget) to render a login portal on the frontend.
...
Now that we have the `authors` collection configured, we can add an `author` field to the `blog` collection. We'll use the [relation widget](https://monumental-eclair-a72b67.netlify.app/docs/widgets/#relation) to define the relationship between blog posts and authors.
...
Our Jekyll blog includes an About page. It would nice to be able to edit that page just like we can edit our blog and author pages. Decap CMS provides [file collections](https://monumental-eclair-a72b67.netlify.app/docs/collection-types/#file-collections) to solve this problem.
