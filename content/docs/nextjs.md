...
Paste HTML for Decap CMS into your `public/admin/index.html` file (check out the [Add Decap To Your Site](https://monumental-eclair-a72b67.netlify.app/docs/add-to-your-site/) section for more information)
...
**Tip:** Signing up with an external provider is the easiest. If you want to sign up by email, you'll have to set up a redirect in your index.js page (which we won't be covering in this guide). For more information, have a look at the [Add To Your Site](https://monumental-eclair-a72b67.netlify.app/docs/add-to-your-site) section.
